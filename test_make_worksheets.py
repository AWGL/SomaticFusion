...
class test_make_worksheets(unittest.TestCase):
	...
	def test_get_star_fusion_report(self):
		...
		self.assertEqual(ws1_Colorectal_output["A11"].value, "NTRK1--Gene3")
		self.assertEqual(ws1_Colorectal_output["A12"].value, "Gene5--NTRK1")		
		self.assertEqual(ws1_Colorectal_output["A13"].value, "Gene6--NTRK1")
		self.assertEqual(ws1_Colorectal_output["A14"].value, "NTRK1--Gene7")
		self.assertEqual(ws1_Colorectal_output["A15"].value, "NTRK1--Gene10")
		self.assertEqual(ws1_Colorectal_output["A16"].value, "NTRK2--Gene3")
		self.assertEqual(ws1_Colorectal_output["A17"].value, "Gene4--NTRK2")		
		self.assertEqual(ws1_Colorectal_output["A18"].value, "Gene5--NTRK2")
		self.assertEqual(ws1_Colorectal_output["A19"].value, "Gene6--NTRK2")
		self.assertEqual(ws1_Colorectal_output["A20"].value, "NTRK3--Gene3")
		self.assertEqual(ws1_Colorectal_output["A21"].value, "Gene4--NTRK3")
		self.assertEqual(ws1_Colorectal_output["A22"].value, "ERROR:NOT ENOUGH SPACE FOR ALL FUSIONS-CHECK RESULTS FILES")
		self.assertEqual(ws1_Colorectal_output["A23"].value, "Gene6--NTRK3")
		self.assertEqual(ws1_Colorectal_output["A24"].value, "NTRK3--Gene7")
		...
		self.assertEqual(ws1_GIST_output["A11"].value, "NTRK1--Gene3")
		self.assertEqual(ws1_GIST_output["A12"].value, "Gene5--NTRK1")		
		self.assertEqual(ws1_GIST_output["A13"].value, "Gene6--NTRK1")
		self.assertEqual(ws1_GIST_output["A14"].value, "NTRK1--Gene7")
		self.assertEqual(ws1_GIST_output["A15"].value, "NTRK1--Gene10")
		self.assertEqual(ws1_GIST_output["A16"].value, "NTRK2--Gene3")
		self.assertEqual(ws1_GIST_output["A17"].value, "Gene4--NTRK2")		
		self.assertEqual(ws1_GIST_output["A18"].value, "Gene5--NTRK2")
		self.assertEqual(ws1_GIST_output["A19"].value, "Gene6--NTRK2")
		self.assertEqual(ws1_GIST_output["A20"].value, "NTRK3--Gene3")
		self.assertEqual(ws1_GIST_output["A21"].value, "Gene4--NTRK3")
		self.assertEqual(ws1_GIST_output["A22"].value, "ERROR:NOT ENOUGH SPACE FOR ALL FUSIONS-CHECK RESULTS FILES")
		self.assertEqual(ws1_GIST_output["A23"].value, "Gene6--NTRK3")
		self.assertEqual(ws1_GIST_output["A24"].value, "NTRK3--Gene7")
		...
		self.assertEqual(ws1_Glioma_output["A11"].value, "BRAF--Gene10")
		self.assertEqual(ws1_Glioma_output["A13"].value, "Gene5--NTRK1")		
		self.assertEqual(ws1_Glioma_output["A14"].value, "Gene6--NTRK1")
		self.assertEqual(ws1_Glioma_output["A15"].value, "NTRK1--Gene7")
		self.assertEqual(ws1_Glioma_output["A16"].value, "NTRK1--Gene10")
		self.assertEqual(ws1_Glioma_output["A17"].value, "NTRK2--Gene3")
		self.assertEqual(ws1_Glioma_output["A18"].value, "Gene4--NTRK2")		
		self.assertEqual(ws1_Glioma_output["A19"].value, "Gene5--NTRK2")
		self.assertEqual(ws1_Glioma_output["A20"].value, "Gene6--NTRK2")
		self.assertEqual(ws1_Glioma_output["A21"].value, "NTRK3--Gene3")
		self.assertEqual(ws1_Glioma_output["A23"].value, "Gene5--NTRK3")
		self.assertEqual(ws1_Glioma_output["A22"].value, "ERROR:NOT ENOUGH SPACE FOR ALL FUSIONS-CHECK RESULTS FILES")
		self.assertEqual(ws1_Glioma_output["A24"].value, "Gene6--NTRK3")
		self.assertEqual(ws1_Glioma_output["A25"].value, "NTRK3--Gene7")
		...
		self.assertEqual(ws1_Lung_output["A15"].value, "Gene4--RET")
		self.assertEqual(ws1_Lung_output["A16"].value, "Gene5--RET")
		self.assertEqual(ws1_Lung_output["A17"].value, "Gene6--RET")		
		self.assertEqual(ws1_Lung_output["A18"].value, "ROS1--Gene1")
		self.assertEqual(ws1_Lung_output["A19"].value, "ROS1--Gene2")
		self.assertEqual(ws1_Lung_output["A20"].value, "ROS1--Gene3")
		self.assertEqual(ws1_Lung_output["A21"].value, "ROS1--Gene4")
		self.assertEqual(ws1_Lung_output["A22"].value, "ERROR:NOT ENOUGH SPACE FOR ALL FUSIONS-CHECK RESULTS FILES")
		self.assertEqual(ws1_Lung_output["A23"].value, "ROS1--Gene6")
		self.assertEqual(ws1_Lung_output["A24"].value, "ROS1--Gene7")
		...
		self.assertEqual(ws1_Melanoma_output["A11"].value, "NTRK1--Gene3")
		self.assertEqual(ws1_Melanoma_output["A12"].value, "Gene5--NTRK1")		
		self.assertEqual(ws1_Melanoma_output["A13"].value, "Gene6--NTRK1")
		self.assertEqual(ws1_Melanoma_output["A14"].value, "NTRK1--Gene7")
		self.assertEqual(ws1_Melanoma_output["A15"].value, "NTRK1--Gene10")
		self.assertEqual(ws1_Melanoma_output["A16"].value, "NTRK2--Gene3")
		self.assertEqual(ws1_Melanoma_output["A17"].value, "Gene4--NTRK2")		
		self.assertEqual(ws1_Melanoma_output["A18"].value, "Gene5--NTRK2")
		self.assertEqual(ws1_Melanoma_output["A19"].value, "Gene6--NTRK2")
		self.assertEqual(ws1_Melanoma_output["A20"].value, "NTRK3--Gene3")
		self.assertEqual(ws1_Melanoma_output["A21"].value, "Gene4--NTRK3")
		self.assertEqual(ws1_Melanoma_output["A22"].value, "ERROR:NOT ENOUGH SPACE FOR ALL FUSIONS-CHECK RESULTS FILES")
		self.assertEqual(ws1_Melanoma_output["A23"].value, "Gene6--NTRK3")
		self.assertEqual(ws1_Melanoma_output["A24"].value, "NTRK3--Gene7")
		...
		self.assertEqual(ws1_NTRK_output["A11"].value, "NTRK1--Gene3")
		self.assertEqual(ws1_NTRK_output["A12"].value, "Gene5--NTRK1")		
		self.assertEqual(ws1_NTRK_output["A13"].value, "Gene6--NTRK1")
		self.assertEqual(ws1_NTRK_output["A14"].value, "NTRK1--Gene7")
		self.assertEqual(ws1_NTRK_output["A15"].value, "NTRK1--Gene10")
		self.assertEqual(ws1_NTRK_output["A16"].value, "NTRK2--Gene3")
		self.assertEqual(ws1_NTRK_output["A17"].value, "Gene4--NTRK2")		
		self.assertEqual(ws1_NTRK_output["A18"].value, "Gene5--NTRK2")
		self.assertEqual(ws1_NTRK_output["A19"].value, "Gene6--NTRK2")
		self.assertEqual(ws1_NTRK_output["A20"].value, "NTRK3--Gene3")
		self.assertEqual(ws1_NTRK_output["A21"].value, "Gene4--NTRK3")
		self.assertEqual(ws1_NTRK_output["A22"].value, "ERROR:NOT ENOUGH SPACE FOR ALL FUSIONS-CHECK RESULTS FILES")
		self.assertEqual(ws1_NTRK_output["A23"].value, "Gene6--NTRK3")
		self.assertEqual(ws1_NTRK_output["A24"].value, "NTRK3--Gene7")
		...
		self.assertEqual(ws1_Tumour_output["A13"].value, "BRAF--Gene10")
		self.assertEqual(ws1_Tumour_output["A14"].value, "NTRK1--Gene3")
		self.assertEqual(ws1_Tumour_output["A15"].value, "Gene5--NTRK1")
		self.assertEqual(ws1_Tumour_output["A16"].value, "Gene6--NTRK1")
		self.assertEqual(ws1_Tumour_output["A17"].value, "NTRK1--Gene7")		
		self.assertEqual(ws1_Tumour_output["A18"].value, "NTRK1--Gene10")
		self.assertEqual(ws1_Tumour_output["A19"].value, "NTRK2--Gene3")
		self.assertEqual(ws1_Tumour_output["A20"].value, "Gene4--NTRK2")
		self.assertEqual(ws1_Tumour_output["A21"].value, "Gene5--NTRK2")
		self.assertEqual(ws1_Tumour_output["A22"].value, "ERROR:NOT ENOUGH SPACE FOR ALL FUSIONS-CHECK RESULTS FILES")
		self.assertEqual(ws1_Tumour_output["A23"].value, "NTRK3--Gene3")
		self.assertEqual(ws1_Tumour_output["A24"].value, "Gene4--NTRK3")
	...
	def test_get_arriba_fusion_report(self):
		...
		self.assertEqual(ws1_Lung_output["A27"].value, "gene1")
		self.assertEqual(ws1_Lung_output["A28"].value, "ALK")
		self.assertEqual(ws1_Lung_output["A29"].value, "gene1")
		...
		self.assertEqual(ws1_Lung_output["B26"].value, "gene2")
		self.assertEqual(ws1_Lung_output["B27"].value,"ALK")
		self.assertEqual(ws1_Lung_output["B28"].value, "gene2")
		self.assertEqual(ws1_Lung_output["B29"].value, "ALK")
		self.assertEqual(ws1_Lung_output["B30"].value, "gene2")
		...
		self.assertEqual(ws1_Tumour_output["A27"].value, "gene1")
		self.assertEqual(ws1_Tumour_output["A28"].value, "ALK")
		self.assertEqual(ws1_Tumour_output["A29"].value, "gene1")
		...
		self.assertEqual(ws1_Tumour_output["B26"].value, "gene2")
		self.assertEqual(ws1_Tumour_output["B27"].value, "ALK")
		self.assertEqual(ws1_Tumour_output["B28"].value, "gene2")
		self.assertEqual(ws1_Tumour_output["B29"].value, "ALK")
		self.assertEqual(ws1_Tumour_output["B30"].value, "gene2")
